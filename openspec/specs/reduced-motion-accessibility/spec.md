# reduced-motion-accessibility Specification

## Purpose
Ensures all animated UI elements respect the user's system-level `prefers-reduced-motion` accessibility preference, disabling or simplifying motion for users with vestibular or motion sensitivity disorders.
