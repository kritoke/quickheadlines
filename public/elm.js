...
{
	if (region.be.aq === region.bx.aq)
	{
		return 'on line ' + region.be.aq;
	}
	return 'on lines ' + region.be.aq + ' through ' + region.bx.aq;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dl, request.ay, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bz: fragment, bF: host, a7: path, bS: port_, bW: protocol, bX: query};
	});
...
var $author$project$Application$Model = F6(
	function (key, url, page, shared, home, timeline) {
		return {af: home, bJ: key, G: page, b: shared, at: timeline, ay: url};
	});
...
var $author$project$Api$FeedsResponse = F4(
	function (tabs, activeTab, feeds, isClustering) {
		return {co: activeTab, c0: feeds, bI: isClustering, dU: tabs};
	});
																		...
																		return A2(
																			...
																			function (totalItemCount) {
																				return $elm$json$Json$Decode$succeed(
																					{bw: displayLink, Q: favicon, T: headerColor, U: headerTextColor, a1: items, b4: siteLink, b7: tab, K: title, ca: totalItemCount, ay: url});
																			},
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cy: false, cG: r.cG, aZ: r.aZ, bB: r.bB, dl: r.dl, d7: r.d7, cb: r.cb, ay: r.ay}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cG: $elm$http$Http$emptyBody, aZ: r.aZ, bB: _List_Nil, dl: 'GET', d7: $elm$core$Maybe$Nothing, cb: $elm$core$Maybe$Nothing, ay: r.ay});
};
...
var $author$project$Api$fetchFeeds = F2(
	function (tab, tagger) {
		return $elm$http$Http$get(
			{
				aZ: A2($elm$http$Http$expectJson, tagger, $author$project$Api$feedsDecoder),
				ay: '/api/feeds?tab=' + $elm$url$Url$percentEncode(tab)
			});
	});
...
var $author$project$Api$TimelineResponse = F4(
	function (items, hasMore, totalCount, isClustering) {
		return {c6: hasMore, bI: isClustering, a1: items, ea: totalCount};
	});
								...
								return function (clusterId) {
									return function (isRepresentative) {
										return function (clusterSize) {
											return {aX: clusterId, bt: clusterSize, Q: favicon, ap: feedTitle, T: headerColor, U: headerTextColor, p: id, aH: isRepresentative, D: link, l: pubDate, K: title};
										};
									};
								};
							};
...
var $author$project$Api$fetchTimeline = F3(
	function (limit, offset, tagger) {
		return $elm$http$Http$get(
			{
				aZ: A2($elm$http$Http$expectJson, tagger, $author$project$Api$timelineDecoder),
				ay: '/api/timeline?limit=' + ($elm$core$String$fromInt(limit) + ('&offset=' + $elm$core$String$fromInt(offset)))
			});
	});
var $author$project$Pages$Timeline$init = function (shared) {
	return _Utils_Tuple2(
		{u: _List_Nil, ae: $elm$core$Maybe$Nothing, P: $elm$core$Set$empty, c6: true, ag: $elm$core$Set$empty, bI: false, a1: _List_Nil, ah: true, E: false, W: 0, bc: false},
...
var $author$project$Application$init = F3(
	function (flags, url, key) {
		...
		var shared = A6(
			...
			zone,
			flags.b1);
		var page = A2($elm$core$String$contains, '/timeline', url.a7) ? 1 : 0;
					...
					return $elm$core$Platform$Sub$batch(
						_List_fromArray(
							[
								...
								$author$project$Pages$Timeline$subscriptions(model.at)),
								A2(
								$elm$core$Platform$Sub$map,
								$author$project$Application$TimelineMsg,
...
var $author$project$Api$fetchFeedMore = F4(
	function (url, limit, offset, tagger) {
		return $elm$http$Http$get(
			{
				aZ: A2($elm$http$Http$expectJson, tagger, $author$project$Api$feedDecoder),
				ay: '/api/feed_more?url=' + ($elm$url$Url$percentEncode(url) + ('&limit=' + ($elm$core$String$fromInt(limit) + ('&offset=' + $elm$core$String$fromInt(offset)))))
			});
	});
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								ae: $elm$core$Maybe$Just('Failed to load feeds'),
								ah: false
							}),
						$elm$core$Platform$Cmd$none);
				}
			...
			case 2:
				...
				var maybeFeed = $elm$core$List$head(
					A2(
						...
						function (f) {
							return _Utils_eq(f.ay, url);
						},
						model.c0));
				var offset = function () {
					if (!maybeFeed.$) {
						var f = maybeFeed.a;
						return $elm$core$List$length(f.a1);
					} else {
						return 0;
					}
				}();
				...
				if (!msg.b.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								ag: A2($elm$core$Set$union, model.ag, addedSet),
								ai: $elm$core$Maybe$Nothing
							}),
						A2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								ae: $elm$core$Maybe$Just('Failed to load feed items'),
								ai: $elm$core$Maybe$Nothing
							}),
						$elm$core$Platform$Cmd$none);
				}
...
var $author$project$Api$toClusterItem = function (item) {
	return {Q: item.Q, ap: item.ap, T: item.T, U: item.U, p: item.p, D: item.D, l: item.l, K: item.K};
};
var $author$project$Api$buildCluster = function (_v0) {
	...
	var representative = function () {
		if (reps.b) {
			...
			if (clusterItems.b) {
				...
				return {aX: $elm$core$Maybe$Nothing, bt: 1, Q: $elm$core$Maybe$Nothing, ap: '', T: $elm$core$Maybe$Nothing, U: $elm$core$Maybe$Nothing, p: '', aH: true, D: '', l: $elm$core$Maybe$Nothing, K: 'Unknown'};
			}
		}
	}();
	...
	var others = A2(
		...
		othersFiltered);
	return {
		bu: $elm$core$List$length(clusterItems),
		p: clusterId,
...
var $author$project$Api$clusterItemsFromTimeline = function (items) {
	...
	var grouped = A3(
		...
		F2(
			function (item, acc) {
				var key = A2($elm$core$Maybe$withDefault, item.p, item.aX);
				var existing = A2(
					$elm$core$List$filter,
					function (_v2) {
						var k = _v2.a;
	...
	function (shared, msg, model) {
		switch (msg.$) {
			case 0:
				if (!msg.a.$) {
					var response = msg.a.a;
					var clusters = $author$project$Api$clusterItemsFromTimeline(response.a1);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								a1: response.a1,
								ah: false,
								W: $elm$core$List$length(response.a1)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								ae: $elm$core$Maybe$Just('Failed to load timeline'),
								ah: false
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 1:
				if (!msg.a.$) {
					...
					var newItemsFromResponse = A2(
						...
						response.a1);
					var newItems = _Utils_ap(model.a1, newItemsFromResponse);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								u: newClusters,
								c6: response.c6,
								ag: A2($elm$core$Set$union, model.ag, addedIds),
								bI: response.bI,
								a1: newItems,
								E: false,
								W: model.W + $elm$core$List$length(newItemsFromResponse)
							}),
						A2(
							$elm$core$Task$perform,
							function (_v1) {
			...
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{E: true}),
					A3($author$project$Api$fetchTimeline, 500, model.W, $author$project$Pages$Timeline$GotMoreTimeline));
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 6:
				...
				var newModel = _Utils_update(
					model,
					{bc: nearBottom});
				return (nearBottom && (model.c6 && ((!model.E) && (!model.ah)))) ? _Utils_Tuple2(
					_Utils_update(
						newModel,
						{E: true}),
					A3($author$project$Api$fetchTimeline, 500, model.W, $author$project$Pages$Timeline$GotMoreTimeline)) : _Utils_Tuple2(newModel, $elm$core$Platform$Cmd$none);
			case 4:
				var clusterId = msg.a;
...
var $author$project$Application$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				var cmd = function () {
					if (!sharedMsg.$) {
						return $author$project$Application$saveTheme(
							$author$project$Shared$themeToString(newShared.as));
					} else {
			...
			case 1:
				var homeMsg = msg.a;
				var _v2 = A3($author$project$Pages$Home_$update, model.b, homeMsg, model.af);
			...
			case 2:
				...
				var _v3 = A3($author$project$Pages$Timeline$update, model.b, timelineMsg, model.at);
			...
			case 3:
				...
				var cmd = A2($elm$browser$Browser$Navigation$pushUrl, model.bJ, newPath);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{G: targetPage}),
			...
			case 6:
				var url = msg.a;
				var newPage = A2($elm$core$String$contains, '/timeline', url.a7) ? 1 : 0;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{G: newPage, ay: url}),
					$author$project$Application$saveCurrentPage(url.a7));
			default:
				var posix = msg.a;
				var shared = model.b;
...
var $mdgriffith$elm_ui$Internal$Model$asRow = 0;
var $mdgriffith$elm_ui$Internal$Style$classes = {cn: 'a', aO: 'atv', cq: 'ab', cr: 'cx', cs: 'cy', ct: 'acb', cu: 'accx', cv: 'accy', cw: 'acr', bo: 'al', bp: 'ar', cx: 'at', aP: 'ah', aQ: 'av', cA: 's', cE: 'bh', cF: 'b', cH: 'w7', cJ: 'bd', cK: 'bdt', az: 'bn', cL: 'bs', aA: 'cpe', cQ: 'cp', cR: 'cpx', cS: 'cpy', B: 'c', aC: 'ctr', aD: 'cb', aE: 'ccx', C: 'ccy', ao: 'cl', aF: 'cr', cU: 'ct', cV: 'cptr', cW: 'ctxt', c2: 'fcs', c4: 'fs', c5: 'g', a$: 'hbh', aG: 'hc', a0: 'hf', bE: 'hfp', c9: 'hv', db: 'ic', dd: 'fr', df: 'iml', dg: 'it', di: 'i', aj: 'nb', bM: 'notxt', dp: 'ol', dr: 'or', X: 'oq', dv: 'oh', G: 'pg', bQ: 'p', dw: 'ppe', dz: 'ui', s: 'r', dB: 'sb', dC: 'sbx', dD: 'sby', dE: 'sbt', dH: 'e', dI: 'cap', dJ: 'sev', dR: 'sk', bh: 't', dV: 'tc', dW: 'w8', dX: 'w2', dY: 'w9', dZ: 'tj', aN: 'tja', d_: 'tl', d$: 'w3', d0: 'w5', d1: 'w4', d2: 'tr', d3: 'w6', d4: 'w1', d5: 'tun', cc: 'ts', _: 'clr', eb: 'u', bj: 'wc', ch: 'we', bk: 'wf', ci: 'wfp', bm: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cA + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.G);
...
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.cA + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dH);
...
var $mdgriffith$elm_ui$Internal$Model$getStyleName = function (style) {
	switch (style.$) {
		...
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.s) + ('-' + ($elm$core$String$fromInt(pos.cT) + ('-' + ($elm$core$String$fromInt(pos.cg) + ('-' + $elm$core$String$fromInt(pos.bC)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.W.a) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.W.b) + 'px'),
					$elm$core$Maybe$Just(
							...
							$mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
								{
									...
									W: A2(
										...
										A2($elm$core$Tuple$mapFirst, $elm$core$Basics$toFloat, shadow.W)),
									b5: shadow.b5
								}));
					},
					focus.dG),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cA) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.s) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cA) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cA) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.s) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cA) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aC) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$sliderOverrides + $mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aB: closing, bP: _List_Nil, J: _List_Nil, y: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								bP: A2(
									$elm$core$List$cons,
									{aB: '\n}', bP: _List_Nil, J: props, y: '@supports (' + (prop + (':' + (value + (') {' + parent.y))))},
									rendered.bP)
							});
					case 4:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.y + ('{' + (renderValues(rule.J) + (rule.aB + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dI + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.bh + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dI + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.bh)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bC: height / size, b5: size, ce: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cO, adjustment.cD, adjustment.cX, adjustment.dj]);
	var lineHeight = 1.5;
				...
				switch (rule.$) {
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + ($elm$core$String$fromInt(position.s) + (' / ' + ($elm$core$String$fromInt(position.s + position.bC) + ';'))),
									'grid-column: ' + ($elm$core$String$fromInt(position.cT) + (' / ' + ($elm$core$String$fromInt(position.cT + position.cg) + ';')))
								]));
						var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.s) + ('-' + ($elm$core$String$fromInt(position.cT) + ('-' + ($elm$core$String$fromInt(position.cg) + ('-' + $elm$core$String$fromInt(position.bC)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.cA + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dH))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.aC, $mdgriffith$elm_ui$Internal$Style$classes.C, $mdgriffith$elm_ui$Internal$Style$classes.cw])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.aC, $mdgriffith$elm_ui$Internal$Style$classes.C, $mdgriffith$elm_ui$Internal$Style$classes.cu])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.aC, $mdgriffith$elm_ui$Internal$Style$classes.cv])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.aC, $mdgriffith$elm_ui$Internal$Style$classes.ct])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[$mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.bh, $mdgriffith$elm_ui$Internal$Style$classes.bj, $mdgriffith$elm_ui$Internal$Style$classes.aG])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[$mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.bh, $mdgriffith$elm_ui$Internal$Style$classes.bk, $mdgriffith$elm_ui$Internal$Style$classes.a0])))
			]),
		_List_fromArray(
			[
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.dS : _Utils_ap(styled.dS, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.cn]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.cF]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.dr]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.dp]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.dd]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.dH, $mdgriffith$elm_ui$Internal$Style$classes.cE]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aP + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bo);
		case 2:
...
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cx);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cq);
		default:
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ao + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.C)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.d3);
...
var $author$project$Application$homeIconView = F2(
	function (model, target) {
		...
		var iconHtml = A2(
			...
			_List_Nil);
		var breakpoint = $author$project$Responsive$breakpointFromWidth(model.b.am);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aE + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.C + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dE + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bM)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{c2: $elm$core$Maybe$Nothing, c9: $elm$core$Maybe$Nothing, dm: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dz, $mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.dH]))),
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ao)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
	...
	function (theme, faviconUrl) {
		...
		return (faviconUrl !== '') ? A2(
			...
			A2(
				...
				{cY: 'Feed favicon', dM: faviconUrl})) : A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width(
...
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.eb);
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								aI: $mdgriffith$elm_ui$Element$text(feed.K),
								ay: feed.b4
							}),
							(feed.bw !== '') ? A2(
							$mdgriffith$elm_ui$Element$el,
							...
							$mdgriffith$elm_ui$Element$text(feed.bw)) : $mdgriffith$elm_ui$Element$none
						]))
				]));
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								aI: $mdgriffith$elm_ui$Element$text(item.K),
								ay: item.D
							})
						])),
					A2(
...
var $mdgriffith$elm_ui$Element$Font$medium = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.d0);
var $author$project$Theme$themeToColors = function (theme) {
	if (!theme) {
		return {
			aS: A3($mdgriffith$elm_ui$Element$rgb255, 18, 18, 18),
			aU: A3($mdgriffith$elm_ui$Element$rgb255, 55, 55, 55),
			aW: A3($mdgriffith$elm_ui$Element$rgb255, 30, 30, 30),
			a5: A3($mdgriffith$elm_ui$Element$rgb255, 148, 163, 184),
			bg: A3($mdgriffith$elm_ui$Element$rgb255, 24, 24, 24),
			bh: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)
		};
	} else {
		return {
			aS: A3($mdgriffith$elm_ui$Element$rgb255, 249, 250, 251),
			aU: A3($mdgriffith$elm_ui$Element$rgb255, 229, 231, 235),
			aW: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255),
			a5: A3($mdgriffith$elm_ui$Element$rgb255, 107, 114, 128),
			bg: A3($mdgriffith$elm_ui$Element$rgb255, 249, 250, 251),
			bh: A3($mdgriffith$elm_ui$Element$rgb255, 17, 24, 39)
		};
	}
};
var $author$project$Pages$Home_$feedCard = F6(
	function (now, theme, breakpoint, loadingFeed, insertedIds, feed) {
		...
		var shouldShowButton = (_Utils_cmp(
			$elm$core$List$length(feed.a1),
			feed.ca) < 0) && (feed.ay !== 'software://releases');
		...
		var isLoadingThisFeed = function () {
			if (!loadingFeed.$) {
				var u = loadingFeed.a;
				return _Utils_eq(u, feed.ay);
			} else {
				return false;
			}
		}();
		var displayedItems = $author$project$Api$sortFeedItems(feed.a1);
		...
		var btnOnPress = isLoadingThisFeed ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			$author$project$Pages$Home_$LoadMoreFeed(feed.ay));
...
var $author$project$Pages$Home_$feedGrid = F2(
	function (shared, model) {
		var theme = shared.as;
		var breakpoint = $author$project$Responsive$breakpointFromWidth(shared.am);
			...
			A2(
				...
				function (feedRow) {
					return A2(
						...
						A2(
							$elm$core$List$map,
							A5($author$project$Pages$Home_$feedCard, shared.$7, theme, breakpoint, model.ai, model.ag),
							feedRow));
				},
...
var $author$project$Pages$Home_$content = F2(
	function (shared, model) {
		...
		return model.ah ? A2(
			...
			$mdgriffith$elm_ui$Element$text('Loading...')) : ((!_Utils_eq(model.ae, $elm$core$Maybe$Nothing)) ? A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$centerX,
...
var $author$project$Pages$Home_$allTab = F2(
	function (shared, activeTab) {
		...
		return A2(
			...
			{
				aI: $mdgriffith$elm_ui$Element$text('All'),
				dq: $elm$core$Maybe$Just(
...
var $author$project$Pages$Home_$tabButton = F3(
	function (shared, activeTab, tab) {
		...
		return A2(
			...
			{
				aI: $mdgriffith$elm_ui$Element$text(tab),
				dq: $elm$core$Maybe$Just(
					$author$project$Pages$Home_$SwitchTab(tab))
			});
	});
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ao + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.C + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bm)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
				...
				if (!padded.$) {
					...
					return ((_Utils_cmp(r, (x / 2) | 0) > -1) && (_Utils_cmp(b, (y / 2) | 0) > -1)) ? $elm$core$Maybe$Just(
						$mdgriffith$elm_ui$Element$paddingEach(
							{aV: b - ((y / 2) | 0), a2: l - ((x / 2) | 0), ba: r - ((x / 2) | 0), bi: t - ((y / 2) | 0)})) : $elm$core$Maybe$Nothing;
				} else {
					return $elm$core$Maybe$Nothing;
				}
			}();
...
var $author$project$Pages$Home_$tabBar = F2(
	function (shared, model) {
		if ($elm$core$List$isEmpty(model.dU)) {
			return $mdgriffith$elm_ui$Element$none;
		} else {
			var theme = shared.as;
			var tabElements = A2(
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							$author$project$Pages$Home_$clusteringIndicator(model.bI)
						])));
			var colors = $author$project$Theme$themeToColors(theme);
			var breakpoint = $author$project$Responsive$breakpointFromWidth(shared.am);
			var isMobile = $author$project$Responsive$isMobile(breakpoint);
	...
	function (now, theme, item) {
		...
		var faviconImg = A2(
			...
			A2(
				$elm$core$Maybe$map,
				function (faviconUrl) {
					return A2($author$project$Pages$ViewIcon$viewIcon, faviconUrl, item.ap);
				},
				item.Q));
		return A2(
			$mdgriffith$elm_ui$Element$paragraph,
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text(item.ap)),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
...
var $author$project$Pages$Timeline$clusterItem = F7(
	function (breakpoint, zone, now, theme, expandedClusters, insertedIds, cluster) {
		...
		var mutedTxt = $author$project$Theme$mutedColor(theme);
		var headerTextColor = A2($elm$core$Maybe$withDefault, '', cluster.bZ.U);
		var headerColor = A2($elm$core$Maybe$withDefault, '', cluster.bZ.T);
		var faviconImg = A2(
			$author$project$Pages$ViewIcon$viewIcon,
			A2($elm$core$Maybe$withDefault, '', cluster.bZ.Q),
			cluster.bZ.ap);
		var clusterCount = cluster.bu;
				...
				[
								...
								[
									...
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$text(cluster.bZ.ap)),
											A2(
											$mdgriffith$elm_ui$Element$el,
											_List_fromArray(
												[
											...
											{
												aI: $mdgriffith$elm_ui$Element$text(cluster.bZ.K),
												ay: cluster.bZ.D
											}),
											(cluster.bu > 1) ? A2(
											$mdgriffith$elm_ui$Element$Input$button,
												...
												]),
											{
												aI: $mdgriffith$elm_ui$Element$text(
													' ↩ ' + $elm$core$String$fromInt(cluster.bu)),
												dq: $elm$core$Maybe$Just(
					...
					_List_fromArray(
						[
							...
							{
								aV: 12,
								a2: $author$project$Responsive$timelineClusterPadding(breakpoint),
								ba: 8,
								bi: 0
							})
						]),
...
var $author$project$Pages$Timeline$dayClusterSection = F7(
	function (breakpoint, zone, now, theme, expandedClusters, insertedIds, dayGroup) {
		return _List_fromArray(
			[
				A5($author$project$Pages$Timeline$dayHeader, breakpoint, zone, now, theme, dayGroup.aY),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
		...
		return A2(
			...
			function (_v0) {
				...
				return {
					...
					aY: A3($author$project$Pages$Timeline$getClusterDateFromKey, zone, key, dayClusters)
				};
			},
			sortedGroups);
	});
...
var $author$project$Pages$Timeline$view = F2(
	function (shared, model) {
		...
		var txtColor = $author$project$Theme$textColor(theme);
		var mutedTxt = $author$project$Theme$mutedColor(theme);
		var clustersByDay = A3($author$project$Pages$Timeline$groupClustersByDay, shared.cm, shared.$7, model.u);
		var breakpoint = $author$project$Responsive$breakpointFromWidth(shared.am);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$none),
					(model.ah && $elm$core$List$isEmpty(model.u)) ? A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$centerX,
					...
					_List_fromArray(
						[
							...
							A2(
								...
								A6($author$project$Pages$Timeline$dayClusterSection, breakpoint, shared.cm, shared.$7, theme, model.P, model.ag),
								clustersByDay)),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
							...
							if (model.E) {
								...
								if (!model.c6) {
									...
									return A2(
										...
										{
											aI: $mdgriffith$elm_ui$Element$text('Load More'),
											dq: $elm$core$Maybe$Just($author$project$Pages$Timeline$LoadMore)
										});
								}
							}
						}()
...
var $author$project$Application$view = function (model) {
	...
	var _v0 = function () {
		var _v1 = model.G;
		if (!_v1) {
			var homeContent = A2($author$project$Pages$Home_$view, model.b, model.af);
			return _Utils_Tuple2(
				'QuickHeadlines',
				A2($mdgriffith$elm_ui$Element$map, $author$project$Application$HomeMsg, homeContent));
		} else {
			var timelineContent = A2($author$project$Pages$Timeline$view, model.b, model.at);
			return _Utils_Tuple2(
				'Timeline',
	...
	var layoutContent = $author$project$Layouts$Shared$layout(
		{
			c3: $author$project$Application$footerView(model.b),
			c7: header,
			dh: isTimeline,
			dk: content,
			as: theme,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{de: $author$project$Application$init, ds: $author$project$Application$UrlChanged, dt: $author$project$Main$handleUrlRequest, dT: $author$project$Application$subscriptions, ec: $author$project$Application$update, ed: $author$project$Application$view});
							...
							return A2(
								...
								function (prefersDark) {
									return A2(
										...
										function (height) {
											return $elm$json$Json$Decode$succeed(
												{bC: height, bT: prefersDark, b1: savedTab, b9: timestamp, cg: width});
										},
