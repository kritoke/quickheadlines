...
var $author$project$Pages$Home_$GotClusters = function (a) {
	return {$: 'GotClusters', a: a};
};
var $author$project$Pages$Home_$Cluster = F4(
	function (id, title, timestamp, sourceCount) {
		return {id: id, sourceCount: sourceCount, timestamp: timestamp, title: title};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Pages$Home_$clusterDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Pages$Home_$Cluster,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'timestamp', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'source_count', $elm$json$Json$Decode$int));
...
var $author$project$Pages$Home_$fetchClustersCmd = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$Pages$Home_$GotClusters,
			$elm$json$Json$Decode$list($author$project$Pages$Home_$clusterDecoder)),
		url: '/api/clusters'
	});
...
var $author$project$Pages$Home_$init = F2(
	function (shared, _v0) {
		return _Utils_Tuple2(
			{activeTab: 'all', clusters: _List_Nil, error: $elm$core$Maybe$Nothing, feeds: _List_Nil, loading: true, tabs: _List_Nil},
			$author$project$Effect$batch(
				_List_fromArray(
					[
						$author$project$Effect$sendCmd(
						$author$project$Pages$Home_$fetchFeeds('all')),
						$author$project$Effect$sendCmd($author$project$Pages$Home_$fetchClustersCmd)
					])));
	});
...
var $author$project$Pages$Home_$update = F3(
	function (shared, msg, model) {
		switch (msg.$) {
			...
			case 'GotClusters':
				if (msg.a.$ === 'Ok') {
					var clusters = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{clusters: clusters, error: $elm$core$Maybe$Nothing, loading: false}),
						$author$project$Effect$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
...
var $author$project$Pages$Home_$clusterList = F3(
	function (windowWidth, theme, clusters) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$text(cluster.title)),
										A2(
										$elm$html$Html$div,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														$elm$core$String$fromInt(cluster.sourceCount) + ' sources')
													])),
												A2(
												$elm$html$Html$span,
												_List_fromArray(
												...
												_List_fromArray(
													[
														$elm$html$Html$text(cluster.timestamp)
													]))
											]))
									]))
							]));
...
var $author$project$Pages$Home_$errorView = function (errorMessage) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background-color', '#fef2f2'),
...
var $author$project$Pages$Home_$loadingIndicator = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'display', 'flex'),
			A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
			A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
			A2($elm$html$Html$Attributes$style, 'padding', '2.5rem')
		]),
	_List_fromArray(
		[
...
var $author$project$Components$Header$logoImage = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$src('/favicon.png'),
					$elm$html$Html$Attributes$alt('QuickHeadlines Logo'),
					A2($elm$html$Html$Attributes$style, 'width', '32px'),
					A2($elm$html$Html$Attributes$style, 'height', '32px')
				]),
			_List_Nil)
		]));
var $author$project$Theme$textColorString = function (theme) {
	if (theme.$ === 'Light') {
		return 'rgb(30, 41, 59)';
	} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						'color',
						$author$project$Theme$textColorString(theme))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('QuickHeadlines')
					]))
			]));
};
...
var $author$project$Components$Header$themeToggle = F2(
	function (theme, onToggleMsg) {
		return A2(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'padding', '0.375rem'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '0.375rem'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'width', '1.25rem'),
						A2($elm$html$Html$Attributes$style, 'height', '1.25rem'),
						A2(
						$elm$html$Html$Attributes$style,
						'color',
						$author$project$Theme$textColorString(theme))
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background-color', '#f1f5f9'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '9999px'),
					A2($elm$html$Html$Attributes$style, 'border-width', '1px'),
					A2($elm$html$Html$Attributes$style, 'border-color', '#e2e8f0')
				]),
			_List_fromArray(
				[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'width', '100%'),
					A2($elm$html$Html$Attributes$style, 'gap', '0.5rem'),
					A2($elm$html$Html$Attributes$style, 'padding-top', '0.75rem'),
					A2($elm$html$Html$Attributes$style, 'padding-bottom', '0.75rem'),
					A2($elm$html$Html$Attributes$style, 'border-bottom-width', '1px'),
...
var $author$project$Theme$tabActiveBgColorString = function (theme) {
	if (theme.$ === 'Light') {
		return 'rgb(239, 246, 255)';
	} else {
		return 'rgb(48, 88, 148)';
	}
};
var $author$project$Theme$tabActiveTextColorString = function (theme) {
	if (theme.$ === 'Light') {
...
var $author$project$Theme$tabHoverBgColorString = function (theme) {
	if (theme.$ === 'Light') {
...
var $author$project$Theme$tabInactiveColorString = function (theme) {
	if (theme.$ === 'Light') {
...
var $author$project$Components$TabBar$tabButton = F4(
	function (theme, activeTab, onTabClick, tab) {
		...
		var textColor = isActive ? $author$project$Theme$tabActiveTextColorString(theme) : $author$project$Theme$tabInactiveColorString(theme);
		var hoverBgColor = (!isActive) ? $author$project$Theme$tabHoverBgColorString(theme) : 'transparent';
		var bgColor = isActive ? $author$project$Theme$tabActiveBgColorString(theme) : 'transparent';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('tab-link'),
					isActive ? $elm$html$Html$Attributes$class('active') : $elm$html$Html$Attributes$classList(_List_Nil),
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'padding',
							$elm$core$String$fromInt(paddingValue) + 'px'),
						...
						[
							...
							_List_fromArray(
								[
									...
									model.loading ? $author$project$Pages$Home_$loadingIndicator : ((!_Utils_eq(model.error, $elm$core$Maybe$Nothing)) ? $author$project$Pages$Home_$errorView(
									A2($elm$core$Maybe$withDefault, '', model.error)) : A3($author$project$Pages$Home_$clusterList, shared.windowWidth, shared.theme, model.clusters))
								]))
						]))
				]),
