	...
	var representative = function () {
		if (reps.b) {
			...
			if (clusterItems.b) {
				...
				return {clusterId: $elm$core$Maybe$Nothing, clusterSize: 1, favicon: $elm$core$Maybe$Nothing, feedTitle: '', headerColor: $elm$core$Maybe$Nothing, headerTextColor: $elm$core$Maybe$Nothing, id: '', isRepresentative: true, link: '', pubDate: $elm$core$Maybe$Nothing, title: 'Unknown'};
			}
		}
	}();
...
var $author$project$Pages$Timeline$textColorFromBgString = function (bgColor) {
	...
	return (luminance >= 128) ? 'rgb(31,41,35)' : 'rgb(255,255,255)';
};
					...
					_List_fromArray(
						[
							...
							A2(
								$elm$html$Html$Attributes$style,
								'color',
								(itemHeaderTextColor !== '') ? itemHeaderTextColor : ((itemHeaderColor !== '') ? $author$project$Pages$Timeline$textColorFromBgString(itemHeaderColor) : '')))
						]),
					{
						label: $mdgriffith$elm_ui$Element$text(item.title),
						url: item.link
											...
											_List_fromArray(
												[
													...
													A2(
														$elm$html$Html$Attributes$style,
														'color',
														(headerTextColor !== '') ? headerTextColor : ((headerColor !== '') ? $author$project$Pages$Timeline$textColorFromBgString(headerColor) : '')))
												]),
