...
<header bind:this={headerElement} class="sticky top-0 z-30 bg-surface-50/95 dark:bg-surface-950/95 backdrop-blur-xl border-b border-surface-200/80 dark:border-surface-700/80 shrink-0" data-name="app-header">
