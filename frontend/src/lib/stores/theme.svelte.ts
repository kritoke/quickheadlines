...
const accentColorsCache: Record<ThemeStyle, { bg: string; bgSecondary: string; text: string; border: string; accent: string; shadow: string }> = {
...
const cursorColorsCache: Record<ThemeStyle, { primary: string; trail: string }> = {
...
const scrollButtonColorsCache: Record<ThemeStyle, { bg: string; text: string; hover: string }> = {
...
const dotIndicatorColorsCache: Record<ThemeStyle, string> = {
	light: '#64748b',
	dark: '#94a3b8',
	retro80s: '#00d4ff',
	matrix: '#22c55e',
...
const customThemeColorsCache: Record<ThemeStyle, { bg: string; text: string; border: string; accent: string; shadow: string }> = {
...
const themePreviewCache: Record<ThemeStyle, string> = {
	light: 'linear-gradient(135deg, #ffffff 50%, #e2e8f0 50%)',
	dark: 'linear-gradient(135deg, #1e293b 50%, #0f172a 50%)',
	retro80s: 'linear-gradient(135deg, #00d4ff 50%, #ff2e63 50%)',
	matrix: 'linear-gradient(135deg, #22c55e 50%, #166534 50%)',
	ocean: 'linear-gradient(135deg, #06b6d4 50%, #f472b6 50%)',
	sunset: 'linear-gradient(135deg, #f97316 50%, #431407 50%)',
	hotdog: 'linear-gradient(135deg, #008080 50%, #fff59d 50%)',
	dracula: 'linear-gradient(135deg, #bd93f9 50%, #282a36 50%)',
	nord: 'linear-gradient(135deg, #88c0d0 50%, #2e3440 50%)',
	cyberpunk: 'linear-gradient(135deg, #ff00ff 50%, #00ffff 50%)',
	forest: 'linear-gradient(135deg, #4ade80 50%, #1a2e1a 50%)',
	coffee: 'linear-gradient(135deg, #d97706 50%, #2c1810 50%)',
	vaporwave: 'linear-gradient(135deg, #ff71ce 50%, #b967ff 50%)'
};

export function getThemePreview(theme: ThemeStyle): string {
	return themePreviewCache[theme];
}
...
export function applyTheme(theme: ThemeStyle) {
	...
	const c = customThemeColorsCache[theme];
...
export function toggleEffects() {
	...
	return accentColorsCache[theme];
}

	export function getDotIndicatorColors(theme: ThemeStyle): string {
	return dotIndicatorColorsCache[theme];
}
